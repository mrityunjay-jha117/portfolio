...
export default function About() {
  return (
    <div
      id="about_section"
      className="min-h-screen lg:h-screen w-full flex flex-col lg:flex-row items-center px-4 sm:px-8 md:px-16 lg:px-24 xl:px-36 justify-center gap-6 sm:gap-8 lg:gap-10 py-16 sm:py-12 select-none"
    >
      <div className="w-full max-w-md sm:max-w-lg lg:max-w-none lg:w-1/2">
        <div className="flex flex-col justify-center items-center lg:items-start w-full text-white">
          ...
          <div className="flex flex-row flex-wrap items-center justify-center lg:justify-start gap-6 sm:gap-8 lg:gap-12 mt-3 mb-4 sm:mb-6">
          ...
          <div className="flex z-20 flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-4 sm:gap-6 items-center mt-6">
